...
@Injectable()
export class VistasAmbientalRepository {
  constructor(
    @Inject('AMBIENTAL_DATA_SOURCE') private readonly ds: DataSource,
  ) {}

  // Vista de login para estudiantes de ambiental
  ...
  // Vista de login para docentes de ambiental
  ...
  // Vista de login para administrativos de ambiental
