...
@Injectable()
export class VistasIngenieriaRepository {
  constructor(
    @Inject('INGENIERIA_DATA_SOURCE') private readonly ds: DataSource,
  ) {}

  // Vista de login para estudiantes de ingeniería
  ...
  // Vista de login para docentes de ingeniería
  ...
  // Vista de login para administrativos de ingeniería
