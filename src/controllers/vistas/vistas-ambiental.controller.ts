...
// Vistas de login y perfil para la Facultad de Ambiental.
// Permite al frontend determinar el rol del usuario dentro de este nodo.
@Controller('api/ambiental/vistas')
export class VistasAmbientalController {
  constructor(private readonly repo: VistasAmbientalRepository) {}
