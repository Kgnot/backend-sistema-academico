...
// Vistas de login y perfil para la Facultad de Ciencias.
// Permite al frontend determinar el rol del usuario dentro de este nodo.
@Controller('api/ciencias/vistas')
export class VistasCienciasController {
  constructor(private readonly repo: VistasCienciasRepository) {}
