...
// Módulo de estudiantes - Facultad de Cieeniería
@Controller('api/ciencias/estudiantes')
export class EstudianteCieController {
  constructor(private readonly repo: EstudianteCieRepository) {}
